...
{
	[CustomEditor (typeof (CustomSphereMask)), CanEditMultipleObjects]
	public class CustomSphereMaskEditor : DeformerEditor
	{
		...
		private class Properties
		{
			...
			public SerializedProperty SphereTransform;
			...
			public Properties (SerializedObject obj)
			{
				...
				SphereTransform		= obj.FindProperty ("sphereTransform");
			}
		}
		...
		public override void OnInspectorGUI ()
		{
			...
			EditorGUILayout.PropertyField (properties.SphereTransform, Content.Axis);
		...
		public override void OnSceneGUI ()
		{
			...
			var sphereMask = target as CustomSphereMask;
		...
		private void DrawInnerRadiusHandle (CustomSphereMask sphereMask)
		{
		...
		private void DrawOuterRadiusHandle (CustomSphereMask sphereMask)
		{
			using (new Handles.DrawingScope (Matrix4x4.TRS (sphereMask.Axis.position, sphereMask.Axis.rotation, sphereMask.Axis.lossyScale)))
			{
				using (var check = new EditorGUI.ChangeCheckScope ())
